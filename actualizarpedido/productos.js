    ...
    try {
        ...
        for (let product of products) {
            let contenidoFila = `<tr>
                ...
                <td>
                <input type="button" onclick="window.location.href='http://127.0.0.1:5504/ok_realizarpedido/orderform.html?id=${product.productId}&nombre=${product.name}&descripcion=${product.description}&precio=${product.sellingPrice}';" value="✅" />
                </td>
            </tr>`;
